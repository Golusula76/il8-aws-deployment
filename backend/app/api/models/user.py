...
class LmsUsers(Base):
    ...
    @staticmethod
    def lms_register(data: dict, db: SessionLocal): # type: ignore
        try:
    ...
    @staticmethod
    def lms_user_update(user_data: UpdateUser, user_id: int, db: SessionLocal): # type: ignore
        try:
    ...
    # ------------------------------------------------------------------------------------------------------------------------------
    @staticmethod
    def lms_delete_user(user_id: int, db: SessionLocal): # type: ignore
        try:
    ...
    #Nikunj
    @staticmethod
    def change_password(current_password: str, new_password: str, user_id: int, is_admin: bool, db: SessionLocal): # type: ignore
        try:
    ...
    @staticmethod
    def user_reset_password(db: SessionLocal, email: str, new_password: str): # type: ignore
        try:
